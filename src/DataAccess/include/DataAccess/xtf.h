/*
 * xtf.h contains the data structure of .xtf format, referred from MB-System.
...
struct xtf_fileheader {
	...
	//float ReferencePointHeight;          /*Height of reference point above water line (m) */
